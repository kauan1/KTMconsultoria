...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_cliente, R.id.nav_contato, R.id.nav_principal,
    ...
    public void enviarEmail(){
        ...
        String celular = "tel:19974175994";
        String imagem = "https://quantocustaviajar.com/blog/wp-content/uploads/2018/04/praia-de-enseada-bertioga-1.jpg";
